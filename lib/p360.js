...
async function getFiles (client, escapedDocumentNumber, recno) {
  try {
    ...
    const file = Array.isArray(documents.Files.DocumentFileResult) ? documents.Files.DocumentFileResult.find(file => file.Recno === parseInt(recno)) : documents.Files.DocumentFileResult
